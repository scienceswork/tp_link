...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig" style="top: 35%;">

                <h2>Register Tp Link</h2>
                ...
                <form action="{{ route('register') }}" method="POST" role="form">
                    ...
                    <div class="group">
                        ...
                        <span class="bar"></span>
                        <label><i class="glyphicon glyphicon-user"></i><span class="span-input"> Name</span></label>
                    </div>
                    ...
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="glyphicon glyphicon-refresh"></span> Register in...</span>
